...
// load the assets
import SantaIsabel from '@/assets/Overview/elevation/shield/SantaIsabel.png';
import CofreDePerote from '@/assets/Overview/elevation/shield/CofreDePerote.png';
import Wrangell from '@/assets/Overview/elevation/shield/Wrangell.png';
import Genovesa from '@/assets/Overview/elevation/shield/Genovesa.png';
import OkiDogo from '@/assets/Overview/elevation/shield/OkiDogo.png';
import ZubairGroup from '@/assets/Overview/elevation/shield/ZubairGroup.png';
// chart options
const defaultOption = {
